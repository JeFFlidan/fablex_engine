...
FE_DEFINE_PROPERTY_TYPE_ENUM_MAPPER(math::Float2, FLOAT2);
FE_DEFINE_PROPERTY_TYPE_ENUM_MAPPER(math::Float3, FLOAT3);
FE_DEFINE_PROPERTY_TYPE_ENUM_MAPPER(math::Float4, FLOAT4);
FE_DEFINE_PROPERTY_TYPE_ENUM_MAPPER(math::Float3x4, FLOAT3X4);
FE_DEFINE_PROPERTY_TYPE_ENUM_MAPPER(math::Float4x4, FLOAT4X4);
